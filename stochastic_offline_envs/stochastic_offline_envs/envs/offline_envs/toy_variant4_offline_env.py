...
from stochastic_offline_envs.envs.gambling.toy_variant4 import ToyStochasticGame
from stochastic_offline_envs.policies.random import RandomPolicy

class ToyVariant4OfflineEnv(BaseOfflineEnv):

    def __init__(self, path=default_path('toy_variant4.ds'), horizon=5, n_interactions=int(1e5)):
