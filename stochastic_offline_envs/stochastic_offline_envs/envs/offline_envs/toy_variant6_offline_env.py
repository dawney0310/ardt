...
from stochastic_offline_envs.envs.gambling.toy_variant6 import ToyStochasticGame
from stochastic_offline_envs.policies.random import RandomPolicy

class ToyVariant6OfflineEnv(BaseOfflineEnv):

    def __init__(self, path=default_path('toy_variant6.ds'), horizon=5, n_interactions=int(1e5)):
